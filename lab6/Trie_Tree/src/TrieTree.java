...
class TrieTree implements TrieTree_methods {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("contains banana? "+st.contains("banana"));  //true
        System.out.println("contains blabla? "+st.contains("blabla"));  //false
        System.out.println("contains ban? "+st.contains("ban"));     //true
        System.out.println("contains ba? "+st.contains("ba"));      //false
    }
}
